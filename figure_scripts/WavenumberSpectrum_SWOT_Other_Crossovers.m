%%! Supplemental Material to not include in the final archive
%% This script is for inspecting individual cross-overs, use the *Loop* script to make all the figures

cd /Users/kachelein/Documents/JPL/papers/my_work/CalVal_StructureFunctions/data/SWOT_Other_Crossovers
% SWOT = load('SWOTdata_SPac85W.mat',...
% SWOT = load('SWOTdata_NPac160E.mat',...
SWOT = load('SWOTdata_largerectangle_NPac161E.mat',...
...
loglog( Freq, 0.1 * [SPEC_(1)/[Freq(1)^SLOPE]] * Freq.^SLOPE, 'r', 'LineWidth',5)
legend('Mean','Median',['k^{' num2str(SLOPE) '}'])
